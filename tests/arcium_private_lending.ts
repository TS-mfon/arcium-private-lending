...
import { ArciumPrivateLending } from "../target/types/arcium_private_lending";
...
describe("ArciumPrivateLending", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ArciumPrivateLending as Program<ArciumPrivateLending>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ArciumPrivateLending>,
